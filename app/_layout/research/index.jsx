...
export function Research() {
  return (
    <article className='container relative bg-black py-12 text-white md:py-16 lg:py-20'>
      <div className='grid grid-cols-1 lg:grid-cols-[25%_50%_25%]'>
          ...
          <div className='lg:sticky lg:top-24'>
            ...
            <ParallaxFade>
              ...
              >
                ...
                me to explore ideas, concepts, materials, techniques, and visual
                influences in greater depth. Through research, I investigate
                different perspectives, study existing work, experiment with new
                approaches, and develop a stronger understanding of design and
                creativity. Each research process helps me discover meaningful
                connections between culture, people, materials, and contemporary
                visual expression. It also allows me to challenge familiar ideas
                and transform inspiration into thoughtful outcomes. These
                explorations continuously shape my creative direction,
                strengthen my problem-solving abilities, and provide a
                foundation for developing work that is expressive, relevant,
                considered, and personally meaningful.
              </Balancer>
            </ParallaxFade>
          </div>
        </div>
        ...
        {/* =====================================================
            MIDDLE — 50%
        ===================================================== */}
        <div className='grid border-white/10 lg:border-x'>
